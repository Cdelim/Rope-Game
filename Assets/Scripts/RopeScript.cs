...
public class RopeScript : MonoBehaviour {
	...
	*/
	...
	public float resolution = 1F;							  //  Sets the amount of joints there are in the rope (1 = 1 joint for every 1 unit)
	public float ropeDrag = 0.1F;								 //  Sets each joints Drag
	public float ropeMass = 0.1F;							//  Sets each joints Mass
	public float ropeColRadius = 0.3F;					//  Sets the radius of the collider in the SphereCollider component
